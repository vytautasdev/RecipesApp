package com.vytautasdev.recipesappmvvm.data
...
import com.vytautasdev.recipesappmvvm.util.Constants.Companion.PREFERENCES_BACK_ONLINE
import com.vytautasdev.recipesappmvvm.util.Constants.Companion.PREFERENCES_CUISINE_TYPE
import com.vytautasdev.recipesappmvvm.util.Constants.Companion.PREFERENCES_CUISINE_TYPE_ID
import com.vytautasdev.recipesappmvvm.util.Constants.Companion.PREFERENCES_DATASTORE_NAME
import com.vytautasdev.recipesappmvvm.util.Constants.Companion.PREFERENCES_DIET_TYPE
import com.vytautasdev.recipesappmvvm.util.Constants.Companion.PREFERENCES_DIET_TYPE_ID
import com.vytautasdev.recipesappmvvm.util.Constants.Companion.PREFERENCES_MEAL_TYPE
import com.vytautasdev.recipesappmvvm.util.Constants.Companion.PREFERENCES_MEAL_TYPE_ID
...
class DataStoreRepository @Inject constructor(@ApplicationContext private val context: Context) {
    ...
    suspend fun saveMealDietCuisineType(
        mealType: String,
        mealTypeId: Int,
        dietType: String,
        dietTypeId: Int,
    ...
    val readMealDietCuisineType: Flow<MealDietCuisineType> = dataStore.data
        .catch { exception ->
